...
def main():
    ...
    parser.add_argument("--model", default=None,
                         help="시작 가중치 (기본: detect=yolov8n.pt, classify=yolov8n-cls.pt)")
    ...
    default_model = "yolov8n.pt" if args.task == "detect" else "yolov8n-cls.pt"
