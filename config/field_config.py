...
#    * type 값(영문 코드)은 아직 원본 슬라이드로 확정되지 않은 placeholder이니 확정되는 대로 교체하세요.
# ---------------------------------------------------------
FACILITY_TYPE_BY_SLOT = {
    "FA-01": "control_tower",   # 관제탑
    "FA-02": "radar",           # 관제레이더
    "FA-03": "hangar",          # 격납고
    "FA-04": "building_1",      # 일반건물1
    "FA-05": "building_2",      # 일반건물2
    "FA-06": "weapon_depot",    # 무기고
}
...
# --- 폭파구/불발탄 YOLO11n 모델 설정 (3-A: zone 타일 배치 추론) ---
